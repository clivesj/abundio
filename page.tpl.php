...
<div id="banner">
  ...
  <?php print render($page['banner']); ?>
    ...
    <?php if (theme_get_setting('slideshow_display', 'abundio')): ?>
        ...
        <div class="slider-item">
            <div class="content container_12">
               <div class="grid_12">
                ...
                <img class="masked" src="<?php print base_path() . drupal_get_path('theme', 'abundio') ;?>/mockup/slide-1.jpg"/>
                </div>
        ...
        <div class="slider-item">
            <div class="content container_12">
              <div class="grid_12">
                ...
                <img class="masked" src="<?php print base_path() . drupal_get_path('theme', 'abundio') ;?>/mockup/slide-2.jpg"/>
                </div>
                <h2>Sample service name</h2             <!--EOF:slider-item content-->
        </div>
            </div>
        </div>
        <!--EOF:slider-item-->
  ...
  <!-- #content-inside -->
    ...
    <?php } else { ?>
        ...
        <?php } ?>
            ...
            <?php if (theme_get_setting('breadcrumb_display','abundio')): print $breadcrumb; endif; ?>
