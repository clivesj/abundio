 ...
 *   The form state.
 */
function abundio_form_system_theme_settings_alter(&$form, &$form_state) {

  $form['mtt_settings'] = array(
    '#type' => 'fieldset',
    '#title' => t('Abundio Theme Settings'),
    '#collapsible' => FALSE,
  '#collapsed' => FALSE,
  );
  ...
  '#default_value' => theme_get_setting('breadcrumb_display','abundio'),
  );

  $form['mtt_settings']['breadcrumb']['breadcrumb_separator'] = array(
    '#type' => 'textfield',
    '#title' => t('Breadcrumb separator'),
  '#default_value' => theme_get_setting('breadcrumb_separator','abundio'),
    '#size'          => 5,
    '#maxlength'     => 10,
  );
  ...
  '#default_value' => theme_get_setting('slideshow_display','abundio'),
  );

  $form['mtt_settings']['slideshow']['slideshow_js'] = array(
    '#type' => 'checkbox',
    '#title' => t('Include slideshow javascript code'),
  '#default_value' => theme_get_setting('slideshow_js','abundio'),
  );
  ...
  '#default_value' => theme_get_setting('slideshow_effect','abundio'),
    '#options' => array(
    'blindX' => t('blindX'),
    'blindY' => t('blindY'),
    'blindZ' => t('blindZ'),
  ...
  '#default_value' => theme_get_setting('responsive_meta', 'abundio'),
  );
  ...
  '#default_value' => theme_get_setting('responsive_respond','abundio'),
